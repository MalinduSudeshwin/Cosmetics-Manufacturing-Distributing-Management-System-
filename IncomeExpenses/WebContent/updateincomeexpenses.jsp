          ...
          <div class="container">
            ...
            <nav class="main-nav" role="navigation">
              <ul class="main-menu">
                ...
                <li><a href="#section2">update Income & Expenses</a></li>
      ...
      <section class="section my-services" data-section="section2">
        <div class="container">
          <div class="section-heading">
			...
			<form class="form1" action="update" method="post">
			    ...
			    Amount <input type="text" name="amount" value="<%= amount%>"><br><br><br>
			    
			    <input class="sub" type="submit" name="submit" value="Upadate">
