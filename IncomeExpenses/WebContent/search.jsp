      ...
      <section class="section my-services" data-section="section2">
        <div class="container">
		  ...
		  <form class="form1" action="insert" method="post">
		      ...
		      Amount <input type="text" name="amount" placeholder=" XXXX.XX" step="0.01"><br><br>
        ...
        <div class="container">
          <div class="section-heading">
			...
			<form class="form2"action="search" method="post">
				Bill ID<input class="un " type="text" name="bid" placeholder = "BillID" ><br><br>	
			...
			<table>
				...
				<c:forEach var="ine" items="${ineDetails}">
				
					<c:set var="id" value="${ine.id}"/>
					<c:set var="billid" value="${ine.billID}"/>
					<c:set var="category" value="${ine.category}"/>
					<c:set var="date" value="${ine.date}"/>
					<c:set var="phone" value="${ine.phone}"/>
					<c:set var="amount" value="${ine.amount}"/>
			 
						<tr>
							<td class="cs">${ine.id}</td>
							<td class="cs">${ine.billID}</td>
							<td class="cs">${ine.category}</td>
							<td class="cs">${ine.date}</td>
							<td class="cs">${ine.phone}</td>
							<td class="cs">${ine.amount}</td>	
			
							<td>	
								<c:url value="updateincomeexpenses.jsp" var="ineupdate">
									<c:param name="id" value="${id}"/>
									<c:param name="billid" value="${billid}"/>
							...
							<td>
								<c:url value="deleteincomeexpenses.jsp" var="ineupdate">
									<c:param name="id" value="${id}"/>
									<c:param name="billid" value="${billid}"/>
									<c:param name="category" value="${category}"/>
									<c:param name="date" value="${date}"/>
